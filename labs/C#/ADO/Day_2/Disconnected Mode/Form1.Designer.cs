namespace Disconnected_Mode
{
    partial class CoursesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbl_crsName.Location = new Point(50, 27);
            ...
            lbl_crsDuration.Location = new Point(375, 27);
            ...
            nud_crsDuration.Location = new Point(516, 24);
            nud_crsDuration.Name = "nud_crsDuration";
            nud_crsDuration.Size = new Size(68, 29);
            nud_crsDuration.TabIndex = 5;
            nud_crsDuration.Value = new decimal(new int[] { 3, 0, 0, 0 });
            nud_crsDuration.ValueChanged += nud_crsDuration_ValueChanged;
            // 
            // lbl_crsTopic
            // 
            ...
            lbl_crsTopic.Location = new Point(675, 27);
            ...
            cb_crsTopic.Location = new Point(789, 23);
            cb_crsTopic.Name = "cb_crsTopic";
            cb_crsTopic.Size = new Size(186, 29);
            ...
            btn_refresh.Location = new Point(50, 79);
            ...
            btn_save.BackColor = Color.FromArgb(118, 171, 174);
            btn_save.FlatStyle = FlatStyle.Flat;
            btn_save.ForeColor = Color.FromArgb(238, 238, 238);
            btn_save.Location = new Point(895, 79);
            btn_save.Margin = new Padding(3, 3, 3, 10);
            ...
            pnl_topForm.Controls.Add(btn_save);
            ...
            dgv_courses.ImeMode = ImeMode.NoControl;
            dgv_courses.Location = new Point(0, 124);
            ...
            dgv_courses.RowHeadersDefaultCellStyle = dataGridViewCellStyle1;
            ...
            dgv_courses.RowsDefaultCellStyle = dataGridViewCellStyle2;
            dgv_courses.Size = new Size(1030, 520);
            dgv_courses.TabIndex = 7;
            dgv_courses.CellEndEdit += dgv_courses_CellEndEdit;
            dgv_courses.CellEnter += dgv_courses_CellEnter;
            dgv_courses.RowHeaderMouseDoubleClick += dgv_courses_RowHeaderMouseDoubleClick;
            dgv_courses.RowsRemoved += dgv_courses_RowsRemoved;
            dgv_courses.RowValidating += dgv_courses_RowValidating;
            // 
            // CoursesForm
            // 
